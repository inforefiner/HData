...
public class SubmitClient {
    ...
    private String receiveLogHost;
    private int receiveLogPort;
    ...
    /**
     */
    public SubmitClient(Configuration conf) throws Exception {
        this(
                "com.inforefiner.hdata.ApplicationMaster",
                conf);
    }

    SubmitClient(String appMasterMainClass, Configuration conf) {
        this.conf = conf;
    ...
    class LogReceiver implements Runnable {
        ...
        public void run() {
            ...
            try {
                serverSocket = new ServerSocket(receiveLogPort);
                System.out.println("LogReceiver: waiting client connection ...");
                clientSocket = serverSocket.accept();
                System.out.println("LogReceiver: client connected, " + clientSocket.getPort());
                ...
                System.out.println("LogReceiver: closing connection ...");
