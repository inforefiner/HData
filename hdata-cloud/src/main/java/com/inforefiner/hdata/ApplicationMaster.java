...
import com.inforefiner.hdata.utils.HdfsUtil;
...
public class ApplicationMaster {
    ...
    private static final String ExecShellStringPath = SubmitClient.SCRIPT_PATH + ".sh";
    private static final String ExecBatScripStringtPath = SubmitClient.SCRIPT_PATH
            + ".bat";
    ...
    private static String HDATA_PATH = "/hdata";
    ...
    private class LaunchContainerRunnable implements Runnable {
        ...
        public LaunchContainerRunnable(
            ...
            this.hdfsUtil = new HdfsUtil(new Configuration());
        }
        ...
        public void run() {
            ...
            setupAppEnv(shellEnv, localResources);
        ...
        private void setupAppEnv(Map<String, String> appEnv, Map<String, LocalResource> localResources) {
            try {
                String[] targets = new String[]{"conf", "lib", "bin", "plugins"};
                for (String str : targets) {
                    List<FileStatus> list = hdfsUtil.list(HDATA_PATH + File.separator + str);
                    for (FileStatus status : list) {
//                        LOG.info("setting app env, file = " + status.getPath());
                        LocalResource resource = Records.newRecord(LocalResource.class);
                        resource.setResource(Path2Url(status.getPath()));
                        ...
                        localResources.put(path.substring(idx), resource);
                    }
                }
...
//        Apps.addToEnvironment(appEnv,
//                ApplicationConstants.Environment.USER.name(),
//                "europa", File.pathSeparator);
//        Apps.addToEnvironment(appEnv,
//                ApplicationConstants.Environment.CLASSPATH.name(),
