...
public class KryoUtils {
    ...
    private static final ThreadLocal<ByteBufferOutput> outputLocal = ThreadLocal.withInitial(() -> {
        ByteBufferOutput output = new ByteBufferOutput(64 * 1024 * 1024);
        return output;
    });
    ...
    public static <T> byte[] writeToByteBuffer(T obj) {
        ByteBufferOutput output = outputLocal.get();
        output.clear();
