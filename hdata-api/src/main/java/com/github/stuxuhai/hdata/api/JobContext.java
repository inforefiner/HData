...
public class JobContext {
    ...
    public String getWriterErrorMsg() {
        return writerErrorMsg;
    }

    public void setWriterErrorMsg(String writerErrorMsg) {
        this.writerErrorMsg = writerErrorMsg;
    }
