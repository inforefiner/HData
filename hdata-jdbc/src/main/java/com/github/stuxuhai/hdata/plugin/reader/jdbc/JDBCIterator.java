...
public class JDBCIterator {
    ...
    protected static class JDBCUnit2 {
        ...
        public JDBCUnit2(String driver, String sql, String selectColumn, String splitColumn, long start, long end, long step, int parallelism) {
            this.driver = driver;
            this.sql = sql;
            this.column = splitColumn;
        ...
        public String getNextSQL(int seq) {
            ...
            if (this.column != null && !this.column.isEmpty() && !JdbcUtils.isSqlServer(driver)) {
                currentSql += " ORDER BY " + this.column;
            }
