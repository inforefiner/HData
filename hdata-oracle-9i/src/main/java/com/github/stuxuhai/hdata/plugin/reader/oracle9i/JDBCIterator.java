package com.github.stuxuhai.hdata.plugin.reader.oracle9i;

import com.github.stuxuhai.hdata.plugin.oracle9i.JdbcUtils;
...
public class JDBCIterator {
    ...
    protected static class JdbcUnit {
        ...
        public JdbcUnit(String driver, String sql, String selectColumn, String splitColumn, String table, long start, long end, long step, int parallelism) {
            this.driver = driver;
            this.sql = sql;
    ...
    public static void main(String[] args) {
        ...
        JdbcUnit jdbcUnit = new JdbcUnit("xxx.oracle.xxx", sql, "*", "", "",0, 2270000, 10000, 4);
        String str = null;
        int i = 0;
